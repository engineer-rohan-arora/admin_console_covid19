...
class UpdtNews extends StatefulWidget {
  static const String id = 'UpdtNews';
  @override
  _UpdtNews createState() => _UpdtNews();
}

class _UpdtNews extends State<UpdtNews> {
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('Add recent news', style: TextStyle(
                fontSize: 24,
